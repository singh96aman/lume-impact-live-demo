...
echo $PATH >> /sdf/group/ad/beamphysics/lume-impact-live-demo/text.txt
...
echo $CONDA_DEFAULT_ENV >> /sdf/group/ad/beamphysics/lume-impact-live-demo/text.txt
...
#salloc --partition milano -N 1 -n 64 /usr/lib64/mpich/bin/mpirun -n 64 echo 'Hello World' >> /sdf/group/ad/beamphysics/lume-impact-live-demo/text.txt
